...
var Page = function (_a) {
    ...
    return (jsxRuntime.jsxs(Container, { "data-testid": "page-container", children: [jsxRuntime.jsx("h1", { className: "page-title", children: title }), children] }));
};
...
var Button = function (_a) {
    var label = _a.label, _b = _a.variant, variant = _b === void 0 ? "primary" : _b, _c = _a.size, size = _c === void 0 ? "medium" : _c, onClick = _a.onClick, props = __rest(_a, ["label", "variant", "size", "onClick"]);
    return (jsxRuntime.jsx(StyledButton, __assign({ type: "button", variant: variant, size: size, onClick: onClick }, props, { children: label })));
};
