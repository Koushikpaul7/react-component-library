...
var Page = function (_a) {
    ...
    return (jsxs(Container, { "data-testid": "page-container", children: [jsx("h1", { className: "page-title", children: title }), children] }));
};
...
var Button = function (_a) {
    ...
    return (jsx(StyledButton, __assign({ type: "button", variant: variant, size: size, onClick: onClick }, props, { children: label })));
};
